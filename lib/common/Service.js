...
var Service = (function () {
  function Service(url, getWebsocket) {
    ...
    var mocks = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];
    var wsMocks = arguments.length <= 4 || arguments[4] === undefined ? {} : arguments[4];
    ...
    if (!getWebsocket) {
      (function () {
        var wsManager = new _websocketsWSManager2['default']();
  ...
  _createClass(Service, [{
        ...
        build: function build(buildCallback) {
          return {
            then: function then(callback) {
              _this2.websocket.subscribe(route, action, function (data) {
    ...
    value: function mockRoutes() {
      ...
      Object.keys(this.routes).forEach(function (resourceName) {
        var resource = _this3.routes[resourceName];
        Object.keys(resource).forEach(function (verb) {
          try {
            var relativeRoute = resource[verb];
            var fullRoute = _this3.getRoute(verb, resourceName).url;
            var mockData = _this3.mocks[relativeRoute][verb];
            _this3.fetch.mock('express:' + fullRoute, delay(mockData), { method: verb });
          } catch (e) {}
        });
      });
    }
