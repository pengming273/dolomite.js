...
var _SlateTokensTokenSummary = require('../../../Slate/Tokens/TokenSummary');

var _SlateTokensTokenSummary2 = _interopRequireDefault(_SlateTokensTokenSummary);

var MockTokenSummary = (function () {
  function MockTokenSummary() {
    _classCallCheck(this, MockTokenSummary);
  }

  _createClass(MockTokenSummary, null, [{
    key: 'tickers',
    get: function get() {
      return Object.keys(MockTokenSummary.All);
    }
  }, {
    key: 'random',
    get: function get() {
      var ticker = mock.sample(MockTokenSummary.tickers);
      return MockTokenSummary.All[ticker];
    }
  }, {
    key: 'All',
    get: function get() {
      return {
        ETH: {
          ...
          precision: 18,
          display_precision: 5,
          token_type: _SlateTokensTokenSummary2['default'].Type.ETH,
          description: '',
          image_url: null,
          thumbnail_url: null,
        ...
        WETH: {
          ...
          precision: 18,
          display_precision: 5,
          token_type: _SlateTokensTokenSummary2['default'].Type.ERC20,
  ...
  return MockTokenSummary;
})();

exports['default'] = MockTokenSummary;
