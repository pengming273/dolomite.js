...
var _exchangeTokensToken = require('../../../exchange/Tokens/Token');

var _exchangeTokensToken2 = _interopRequireDefault(_exchangeTokensToken);

var MockToken = (function () {
  function MockToken() {
    _classCallCheck(this, MockToken);
  }

  _createClass(MockToken, null, [{
    key: 'All',
    get: function get() {
      return {
        ETH: {
          ...
          precision: 18,
          display_precision: 5,
          token_type: _exchangeTokensToken2['default'].Type.ETH,
          description: '',
          image_url: null,
          thumbnail_url: null,
        ...
        WETH: {
          ...
          precision: 18,
          display_precision: 5,
          token_type: _exchangeTokensToken2['default'].Type.ERC20,
