...
var _TokensTokenService = require('./Tokens/TokenService');

var _TokensTokenService2 = _interopRequireDefault(_TokensTokenService);
  ...
  function Slate() {
    ...
    _get(Object.getPrototypeOf(Slate.prototype), 'constructor', this).call(this, {
      ...
      services: {
        ...
        tokens: _TokensTokenService2['default']
      }
    });
  }
