...
function () {
  function Transfer(_ref, ownerAddress) {
    var dolomite_token_id = _ref.dolomite_token_id,
        ...
        transfer_amount_token = _ref.transfer_amount_token,
        ...
        transfer_amount_value = _ref.transfer_amount_value,
    ...
    this.value = new _BigNumber["default"](transfer_amount_token);
    this.valueFiat = new _BigNumber["default"](transfer_amount_value);
