...
function () {
  function Order(_ref) {
    var dolomite_order_id = _ref.dolomite_order_id,
        ...
        amount_dealt_primary = _ref.amount_dealt_primary,
        amount_dealt_secondary = _ref.amount_dealt_secondary,
    ...
    this.dealtAmountPrimary = new _BigNumber["default"](amount_dealt_primary);
    this.dealtAmountSecondary = new _BigNumber["default"](amount_dealt_secondary);
