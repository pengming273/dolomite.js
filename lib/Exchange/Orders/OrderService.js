  ...
  _createClass(OrderService, [{
    ...
    value: function getDepthChart(primaryTicker, secondaryTicker) {
      ...
      return this.get('depth', {
        ...
        return _DepthChart["default"].build(body.data);
      });
    }
  }, {
    key: "watchDepthChart",
    ...
    value: function onDepthChartUpdate(callback) {
      this.on('/v1/orders/markets/-market-/depth/merged', 'update').build(function (data) {
        return _DepthChart["default"].build(data);
      }).then(callback);
    } // ----------------------------------------------
    // Order Fills
    ...
    value: function onFillsUpdate(callback) {
      this.on('/v1/orders/markets/-market-/fills', 'update').build(function (data) {
