...
var Account = function Account(_ref) {
  var dolomite_account_id = _ref.dolomite_account_id,
      ...
      current_verification_tier = _ref.current_verification_tier,
  ...
  var daily_max_trade_amount_usd = current_verification_tier.daily_max_trade_amount_usd,
      information_required = current_verification_tier.information_required,
      verification_tier_number = current_verification_tier.verification_tier_number;
