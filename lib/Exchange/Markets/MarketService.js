...
function (_Service) {
  ...
  function MarketService(url, websocket) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MarketService).call(this, url, websocket, routes));
  }
  ...
  _createClass(MarketService, [{
    ...
    value: function getAll() {
      ...
      return this.get('markets', options).then(function (body) {
        return _Market["default"].hydrate(body.data, body.globals);
      });
    }
  }]);
